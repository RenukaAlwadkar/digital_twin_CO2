/**
 * Real Indian cities with their geographic coordinates.
 * Data sourced from OpenStreetMap / official geographic data.
 */
const CITIES = [
  { id: 'delhi',       name: 'Delhi',       lat: 28.6139, lng: 77.2090, state: 'Delhi' },
